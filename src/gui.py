...
class GUI:
	...
	def compile_experiment(self):
		...
		# Decompose QuantumCircuit into program-native circuit
		native_circuit_data = []
	...
	def load_output(self):
		...
		text_label.config(text="Visualization complete! You can now head back to the main menu to start another experiment!")
